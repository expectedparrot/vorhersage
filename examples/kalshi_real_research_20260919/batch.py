...
def prepare():
    ...
    cases = [c for c in load(OUT / "cases.json") if c["id"] in {"measles", "global_heat"} and eligibility[c["id"]]["eligible"]]
    ...
    specification = {"id": "kalshi-repeated-20260918", "version": 1,
        ...
        "evidence_policy": "frozen_packets", "order_seed": "real-research-two-question-v1"}
